...
public class MainFrame extends JFrame {
    ...
    private JMenuItem stopBlueMenuItem;  // доп задание
    ...
    public MainFrame() {
        ...
        Action stopBlueAction = new AbstractAction("Приостановить движение синих мячей"){ // доп задание
            public void actionPerformed(ActionEvent event) {
                field.stopBlue();
                pauseMenuItem.setEnabled(false);
                resumeMenuItem.setEnabled(false);
                stopBlueMenuItem.setEnabled(true);
                accelerationMenuItem.setEnabled(false);
                retardMenuItem.setEnabled(false);
            }
        };

        stopBlueMenuItem = controlMenu.add(stopBlueAction);
        stopBlueMenuItem.setEnabled(true);
        ...
        Action resumeAction = new AbstractAction("Возобновить движение") {
            public void actionPerformed(ActionEvent event) {
                ...
                resumeMenuItem.setEnabled(false);
                //stopBlueMenuItem.setEnabled(false);
