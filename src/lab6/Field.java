...
public class Field extends JPanel {
    ...
    //Пауза для синих, до задание
    public synchronized void stopBlue() {
        stopBlue = true;
   ...
   public synchronized void retard() {
    ...
    public synchronized void canMove(BouncingBall ball) throws InterruptedException {
        ...
        if (ball.getColor().getBlue() > ball.getColor().getRed()+ball.getColor().getGreen() && stopBlue) { //доп задание
            wait();
        }
    }
}